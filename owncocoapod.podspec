#
#  Be sure to run `pod spec lint owncocoapod.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Duale Abdullahi"
  # spec.authors            = { "Duale Abdullahi" => "abdull53@msu.edu" }
  # spec.social_media_url   = "https://twitter.com/Duale Abdullahi"
  ...
  spec.source_files  = "owncocoapod/**/*.{h,m}"
